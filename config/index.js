export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wx95aab82f8fea2cf6",

  // 公众号APP_SECRET
  APP_SECRET:"3708fa1d768abcc826fab90f7d9bc2b5"
   * 接收公众号消息的微信号，如果有多个，需要在[]
   */
  USERS: [
    {
      // 想要发送的人的名字
      ...
      id: "oJg9d5mZ9MC2378e0Kx2KsiczjQI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "6atLaklyAqRKhwb09lrnv0Xffbxibz-IMJGtQnj3HXA",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
